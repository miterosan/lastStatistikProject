...
d_cleaned <- 
  ...
  # use filter to remove the observations where the background check question was answered wrongly
  filter(!str_detect(condition,'^Condition') | background_correct == TRUE)
```
