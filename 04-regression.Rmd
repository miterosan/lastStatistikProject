...
IDA_data_KoF <- IDA_data_KoF %>% 
  ...
  arrange(proportion_correct) %>% filter(outlier_subject == FALSE)

#IDA_data_KoF <- IDA_data_KoF %>% mutate(to_remove = subject_error_rate$outlier_subject)
IDA_data_KoF <- IDA_data_KoF %>% filter(to_remove == FALSE)
